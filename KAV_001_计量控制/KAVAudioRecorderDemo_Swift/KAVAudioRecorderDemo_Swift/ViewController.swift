...
class ViewController: UIViewController {
    ...
    // MeterTable , 自己实现的
    let meterTable = KMeterTable(tableSize: 100)
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        if (segue.identifier)! == "optionsSegue"{
            let optionsVC = segue.destination as! KAudioOptionsViewController
...
extension ViewController: KAudioOptionsViewControllerDelegate{
